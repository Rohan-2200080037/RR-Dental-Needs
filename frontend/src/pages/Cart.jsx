                            ...
                            <Card className="p-6 sm:p-8 sticky top-24 border-slate-200 shadow-md">
                                ...
                                <dl className="space-y-4 text-sm text-slate-600">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <dd>
                                            {calculateTotal() >= FREE_SHIPPING_THRESHOLD ? (
                                    ...
                                    {calculateTotal() < FREE_SHIPPING_THRESHOLD && calculateTotal() > 0 && (
                                        <div className="flex items-center justify-center gap-1.5 text-[11px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2 -mx-2">
